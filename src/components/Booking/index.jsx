...
export default function Booking() {
    ...
    console.log(spots);
    const calendly = <Calendly user={user} spots={spots} setOpen={() => closeCalendly()} openCalendly={openCalendly} />;
    ...
    return (
        <>
            <Container backgroundColor={'var(--second-color)'}>
                <LogoWithBackground />
                {sideView === 'calendly'
                    ? calendly :
                    <Banner backgroundColor={'var(--main-color)'}>
                        <Title>
